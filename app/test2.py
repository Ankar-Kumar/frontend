...
if options:
    ...
    with col1:
        ...
        video_width = 320  # Set your desired width
        video_height = 240  # Set your desired height

        # Use HTML and CSS to render the video with specified size
        st.markdown(
            f'''
            <div style="max-width: {video_width}px; max-height: {video_height}px;">
